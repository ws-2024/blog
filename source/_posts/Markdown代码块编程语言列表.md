...
| Elm                                | elm                                          | \*.elm                      |
| Emacs Lisp                         | emacs-lisp, elisp, emacs                     | \*.el, .abbrev\_defs        |
...
| KRL                                | krl                                          | \*.krl                      |
| KiCad Layout                       | kicad-layout, pcbnew                         | \*.kicad\_pcb, fp-lib-table |
...
| Shell                              | shell, sh, shell-script, bash, zsh           | \*.sh, .bash\_aliases       |
...
| dircolors                          | dircolors                                    | \*.dircolors, .dir\_colors  |
| eC                                 | ec                                           | \*.ec                       |
| edn                                | edn                                          | \*.edn                      |
| fish                               | fish                                         | \*.fish                     |
